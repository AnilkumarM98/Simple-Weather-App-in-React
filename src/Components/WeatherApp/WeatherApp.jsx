        ...
        <div className="container">
            <div className="top-bar">
                ...
                <div className="search-icon">
                    <img src={search_icon} alt="Search" id="searchicon" onClick={() => { search() }} />
                </div>
            </div>
            <div className="weather-image">
                <img src={wicon} alt="Cloud" id="cloudicon" />
            </div>
            <div className="weather-temp">24°C</div>
            <div className="weather-loaction">London</div>
            <div className="data-container">
                <div className="element">
                    <img src={humidity_icon} alt="Humidity" className="icon" id="humidityicon" />
                    <div className="data">
                        <div className="humidity-percent">{humidity[0].innerHTML}</div>
                        <div className="text">Humidity</div>
                    </div>
                </div>
                <div className="element">
                    <img src={wind_icon} alt="Wind" className="icon" id="windicon" />
                    <div className="data">
                        <div className="wind-rate">{wind[0].innerHTML}</div>
